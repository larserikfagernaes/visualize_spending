 ...
 */
export const useTransactions = (page = 1, filters?: FilterState) => {
  ...
  return useQuery({
    ...
    placeholderData: (prev) => prev as PaginatedResponse<Transaction>,
  });
};
 ...
 */
export const useAllTransactions = (filters?: FilterState) => {
  return useQuery({
 ...
 */
export const useTransactionSummary = (filters?: FilterState) => {
  return useQuery({
 ...
 */
export const useTransactionWithRawData = (id?: number) => {
  return useQuery({
